...
class DesignerController extends Controller
{
    ...
    public function saveState(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'state.elementLayout.*.x' => ['required', 'numeric'],
            'state.elementLayout.*.y' => ['required', 'numeric'],
            'state.elementLayout.*.w' => ['required', 'numeric'],
            'state.elementLayout.*.fontSize' => ['required', 'numeric'],
            'state.elementLayout.*.zIndex' => ['nullable', 'numeric'],
            'state.elementLayout.*.color' => ['required', 'string', 'max:32'],
            'state.elementLayout.*.shadow' => ['required', 'boolean'],
            'state.elementLayout.*.border' => ['required', 'boolean'],
