...
async function getCSSRules(
  ...
  // First loop inlines imports, filtrando hojas de estilo según options.cssFilter
  styleSheets.forEach((sheet) => {
    const href = sheet.href || null;
    if (typeof options.cssFilter === 'function' && !options.cssFilter(href)) {
      return;
    }
    console.log(`Processing stylesheet: ${href || 'inline style'}`);
